...
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event){
        ...
        generator.addProvider(event.includeServer(), new LootTableProvider(packOutput, Collections.emptySet(),
                List.of(new LootTableProvider.SubProviderEntry(CBBlockLootTableProvider::new, LootContextParamSets.BLOCK)), lookupProvider));
        generator.addProvider(event.includeServer(), new CBVanillaRecipeGen(packOutput, lookupProvider));
